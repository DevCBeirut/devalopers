...
class GitHubLogin extends Component {
    ...
    render() {
        ...
        return <a variant="primary"  {...attrs}    className="btn btn-sm  btn text-white d-flex" style={{background:"#444444"}} ><FontAwesome name="github" /> <span style={{    position: "relative",
            top: 1,
            left: 15,
        }}>{buttonText}</span></a>;
    }
