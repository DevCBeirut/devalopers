...
class Applications extends CoreEngine {
    ...
    async callPage() {
        ...
        const response = await this.engine.getItem("user", "/my/application");
                                    ...
                                    {!loading && data.length === 0 && <div className=" p-1 bg-white mb-4 jobsitem mt-2">
                                        <div className="row p-3 pl-4">
                                            <div className="col-md-7  font-weight-bold">
                                                <h5 className="mb-1 ">No Saved Applications</h5>
                                            </div>
                                        </div>
                                    </div>}
...
export default connect(null, mapDispatchToProps)(withRouter(Applications));