...
import signup from "../../assets/images/signupdev.jpg";
...
class Signupdev extends CoreEngine {
    ...
    handleValidSubmit = async () => {
        ...
        try {
            const response = await this.engine.postItem("user", this.state)
    ...
    componentDidMount() {
        Utilites.setCookie("regtype","dev");
        this.callPage()
    }
    async callPage() {
        this.props.loadingAction(true);
        const response = await this.engine.getItem("talenttype");
        this.setState({
            loading: true,
        })
        if (response && response.status === 200) {
    ...
    render() {
        ...
        return (
            <>
                    ...
                    <div className="container sign-up">
                        ...
                        <div className="row d-flex  bg-white bordershadow ">
                            <div className=" col-lg-6 col-md-6 pl-0 ml-0 pr-0 mr-0 text-left">
                                <img src={signup} width="100%" className="img-fluid" />
                            </div>
                                ...
                                <div className="card border-0">
                                    <div className="card-body p-3">
                                        ...
                                        <AvForm onValidSubmit={() => this.handleValidSubmit()} className="contactinput noshadow">
                                            <SelectRow label={"I am a .."} name="type" changeInput={this.changeInput.bind(this)} data={this.state.talentsList} />
                ...
                <Modal show={this.state.showterms} onHide={() => this.setState({showterms:!this.state.showterms})}  >
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(Signupdev));
