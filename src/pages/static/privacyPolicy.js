        ...
        return (
            <>
                ...
                <div className="main-cover">
                    <TopHeader title={strings.privacy_policy}
                        subtitle={strings.privacy_policy_effective_date}
                    />
                            ...
                            <div className="p-3 col-lg-12 col-md-12">
                                <div className="card border-0">
                                    ...
                                    <div className="col-lg-11 col-md-11 mx-auto">
                                        ...
                                        <h3>DEVALOPERS ("us", "we", or "our") operates the https://devalopers.com/ website (the "Service").</h3>
                                        ...
                                        <p>DEVALOPERS uses the collected data for various purposes:</p>
                                        <ul>
                                        ...
                                        <p>If you are located outside Lebanon and choose to provide information to us, please note that we transfer the
                                            data, including Personal Data, to Lebanon and process it there.</p>
                                        ...
                                        <p>DEVALOPERS will take all steps reasonably necessary to ensure that your data is treated securely and in
                                        ...
                                        <p>DEVALOPERS may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
                                        <ul>
                                            <li>To comply with a legal obligation</li>
                                            <li>To protect and defend the rights or property of DEVALOPERS</li>
