    ...
    const renderPageNumbers = pageNumbers.map((number, index) => {
      return (
        <PaginationItem key={index}>
          <PaginationLink onClick={this.onPageClick(number)}>
            {number}
          </PaginationLink>
        </PaginationItem>
      );
                  ...
                  {filteredData &&
                    filteredData.map((item, index) => {
                      ...
                      return (
                        <div
                          key={index}
                          className="pt-0 col-xl-4 col-lg-6 col-md-6  talent-profile"
                        >
                          ...
                          <div className="card border-0">
                            <div className="card-body text-center">
                              <Link
                                to={'/dev/profile/' + item._id}
                                className="text-primary"
                              >
                                <h4 className="font-weight-bold deepgray ">
                                  {item.name}
                                </h4>
                              </Link>
                              <h5 className="mt-1 ">
                              ...
                              >
                                {item.skills &&
                                  item.skills.map(i => {
                                    return (
                                      <div className="mb-1 tag btntag searchtag bg-white">
                                        {i.name}
                                      </div>
                                    );
                                  })}
                              ...
                              >
                                <h6 className="mt-3 mb-3">View Profile</h6>
                              </Link>
                            </div>
                          </div>
                        </div>
